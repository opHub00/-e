...
const seed={...SAMDO_REVIEW_SEED,rules:SAMDO_REVIEW_SEED.rules.map(rule=>({...rule,originalCandidateHash:hashReviewCandidate(rule.originalCandidate)}))};
...
console.log(`Rule Review staging seed created for ${data.ruleSetId}; source status remains ${SAMDO_REVIEW_SEED.sourceStatus}`);
