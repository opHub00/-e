...
export function RuleReviewConsole({ onBack, repository, gateway, onSessionEnded, onRetryLoad }: ConsoleProps) {
  const { workspace, summary, gate, rules, detail, actions, save, clearFeedback, refresh } = useRuleReviewWorkspace(repository, gateway);
  ...
  return (
    <SafeAreaView style={styles.screen} edges={['top']}>
      ...
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        <ActivationPanel gate={gate} serverConfirmed={save.kind !== 'FAILED' && !saving} />
...
function ActivationPanel({ gate, serverConfirmed }: { gate: ReturnType<typeof useRuleReviewWorkspace>['gate']; serverConfirmed: boolean }) {
  /*
