...
export function RuleDetailPanel({ detail, record, workspace, blockReasons, locked, saving, revalidation, actions, onDirtyChange }: Props) {
    ...
    <View style={styles.panel}>
      ...
      {editing ? (
        <RuleEditForm
          ...
          onCancel={() => { clearReviewDraft(); setEditing(false); }}
          onSave={async next => {
            ...
            if (result.ok) { clearReviewDraft(); setEditing(false); onDirtyChange(false); }
          }}
        />
      ) : null}
