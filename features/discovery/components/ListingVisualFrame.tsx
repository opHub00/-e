...
import { getListingVisualErrorFallback } from '../../listingVisual/selectListingVisual';
import type { ListingVisual } from '../../listingVisual/types';
import { listingVisualIcon } from './listingVisual';
...
export function ListingVisualFrame({ visual, housingType, variant, placeLabel, style }: Props) {
  ...
  const shown = failed ? getListingVisualErrorFallback(visual) : visual;
