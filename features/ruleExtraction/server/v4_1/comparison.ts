...
export type AuditMetric={numerator:number|null;denominator:number|null;measured:boolean;coverage:{evaluated:number;universe:number;ratio:number};methodology:string;value:number|null};
